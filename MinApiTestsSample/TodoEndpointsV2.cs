...
{ 
    ...
    public static async Task<Ok<List<Todo>>> GetAllIncompletedTodos(
        ITodoService todoService)
    {
    ...
    // get todo by id
    public static async Task<Results<Ok<Todo>, NotFound>> GetTodo(
    ...
    // create todo
    public static async Task<Created<Todo>> CreateTodo(
        TodoDto todo, ITodoService todoService)
    {
    ...
    // update todo
    public static async Task<Results<Created<Todo>, NotFound>> UpdateTodo(
        Todo todo, ITodoService todoService)
    {
        ...
        if (existingTodo != null)
        {
            ...
            return TypedResults.Created($"/todos/v1/{existingTodo.Id}", 
                existingTodo);
        }
